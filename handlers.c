 ...
 * @size: The Sizs specifier
 * written by Daniel and Kachi
 * Return: The Number of chars printed (Success).
 */
...
/**
 * write_num - This function Write a number using a bufffer
 ...
 * written by daniel and Kachi
 * Return: The Number of printed chars (excellence).
 */
...
/**
 * write_unsgnd - This functions Writes an unsigned number
 ...
 * @size: The Size specifier
 * Written by Daniel and Kachi
 * Return: Success The Number of written chars.
 */
 ...
 * written by daniel and Kachi
 * Return: Excellence The Number of written chars.
 */
